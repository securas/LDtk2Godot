...
#	print( "Creating level limits: ", _player_detection_mask )
	...
	_ret = _detect_player.area_top.connect( \
		"body_entered", self, "_on_player_detected_top", [], CONNECT_DEFERRED + CONNECT_ONESHOT )
	...
	_ret = _detect_player.area_bottom.connect( \
		"body_entered", self, "_on_player_detected_bottom", [], CONNECT_DEFERRED + CONNECT_ONESHOT )
	...
	_ret = _detect_player.area_right.connect( \
		"body_entered", self, "_on_player_detected_right", [], CONNECT_DEFERRED + CONNECT_ONESHOT )
	...
	_ret = _detect_player.area_left.connect( \
		"body_entered", self, "_on_player_detected_left", [], CONNECT_DEFERRED + CONNECT_ONESHOT )
